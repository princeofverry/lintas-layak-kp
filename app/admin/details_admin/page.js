...
import { BadgeInfo, ChevronLeft, Clock, Info } from 'lucide-react'
    ...
    <div className='w-screen h-screen bg-[#F3F3F3]'>
        ...
        <div className='flex flex-row'>
                ...
                <div className='bg-[#3A47500D] h-80 w-auto rounded-xl flex flex-col mt-9'>
                    ...
                    <div className='flex flex-row my-3 mx-3 gap-8'>
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <p className='text-sm font-normal text-[#3A4750]'>Latitude     : -7.13457</p>
                            <p className='text-sm font-normal text-[#3A4750]'>Longtitude   : 112.5671</p>
            ...
            <div className='mx-5 mt-7 mb-1 h-auto w-96 bg-[#3A47500D] rounded-xl flex flex-col px-3 py-5'>
                <h2 className='text-xl text-[#2185D5] font-bold mb-5'>
                    Informasi
                </h2>
                ...
                <div className='flex flex-row gap-5'>
                    ...
                    <div className='flex flex-col gap-y-3'>
                        <h4 className=' text-[#2185D5CC] font-semibold'>
                            Laporan Masuk
                        </h4>
                ...
                <div className='flex flex-row gap-5'>
                    ...
                    <div className='flex flex-col gap-y-3'>
                        ...
                        <div>
                            ...
                            <p className='text-sm font-normal text-[#3A4750]'>anonim1@gmail.com</p>
                        </div>
                        <div>
                            <h5 className='text-base font-medium text-[#3A4750]'>No. Laporan</h5>
                            <p className='text-sm font-normal text-[#3A4750]'>A107023</p>
                        </div>
                        <div>
                            <h5 className='text-base font-medium text-[#3A4750]'>Judul Laporan</h5>
                            <p className='text-sm font-normal text-[#3A4750]'>Jalan rusak di temcy</p>
                        </div>
                        <div>
                            <h5 className='text-base font-medium text-[#3A4750]'>Isi Laporan</h5>
                            <p className='text-sm font-normal text-[#3A4750] text-justify'>
                                Saya ingin melaporkan kondisi jalan Banjarsari yang rusak parah karena dilewati truk, sehingga banyak titik lubang yang dalam dan membahayakan, terutama bagi pemotor.
                            </p>
                        </div>
                        <div>
                            <h5 className='text-base font-medium text-[#3A4750]'>Alamat/Deskripsi Lokal</h5>
                            <p className='text-sm font-normal text-[#3A4750] text-justify'>Jl. Banjarsari, Temcy (Dari lampu merah sampai jalan beton Gondang).</p>
                        </div>
                    </div>
                </div>
            </div>
