...
const Footer = () => {
    return (
        <footer className="w-100 bottom-0 left-0 px-8 bg-[#2185D5] text-[#F3F3F3] text-left p-4">
            ...
            <p className="font-poppins text-base leading-8">Website ini dikelola oleh Dinas Kominfo Kota Semarang.</p>
            <p className="font-poppins text-base leading-8 pb-8">Sekayu, Kec. Semarang Tengah, Kota Semarang, Jawa Tengah 50132.</p>
            <hr/>
            <div className='flex justify-between items-center pt-4'>
                <p className="font-poppins text-base font-[40px]">&copy; 2024 Dinas Kominfo Kota Semarang. All Right Reserved</p>
                <div className="flex w-auto h-4">
                    ...
                    <img src='/images/x.png' alt="Logo" className='px-2'/>
                    ...
                    <img src='/images/youtube.png' alt="Logo" className='px-2'/>
                </div>
            </div>
        </footer>
    )
