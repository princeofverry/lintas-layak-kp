        ...
        <div className="relative w-full h-screen bg-[#F3F3F3] font-poppins">
            ...
            <div className="relative w-full h-[600px] md:bg-[#2185D5]">
                <div className="absolute z-10 top-24 left-8 md:left-16 max-w-[464px]">
                    ...
                    <p className="text-[12px] md:text-[22px] font-normal text-[#F3F3F3] w-[270px] md:w-full mb-12">Jalan berlubang dapat membahayakan keselamatan kita semua. Sampaikan laporan Anda mengenai kondisi jalan yang perlu diperbaiki.</p>
